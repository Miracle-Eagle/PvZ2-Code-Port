...
{
/** <summary> Retrieves all the Properties related to the SnowPeaFreezingProjectile Class. </summary>
<remarks> This Class uses the ProjectilePropertySheet for Saving Info of the Current Instance. </remarks> */

class SnowPeaFreezingProjectileProps : public ProjectilePropertySheet
{
...
/// <summary> Initializes a new Instance of the SnowPeaFreezingProjectileProps Class. </summary>

SnowPeaFreezingProjectileProps();
};
