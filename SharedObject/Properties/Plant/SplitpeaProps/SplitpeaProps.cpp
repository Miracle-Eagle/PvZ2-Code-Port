...
{
/// <summary> Setups all the Fields from the SplitpeaProps Instance. </summary>

SplitpeaProps::SplitpeaProps()
{
this->Cost = std::make_optional(125);
this->BeghouledCost = std::make_optional(1000);
...
this->PlantFoodForwardProjectileCount = std::make_optional(60);
this->PlantFoodBackwardProjectileCount = std::make_optional(90);
...
{
Type = StatType::range,
Value = StatValue::range_frontback
},
...
this->ZenGardenSproutWeight = std::make_optional(100);
...
SuggestionAlts = { "firepeashooter", "celerystalker", "peashooter" };
}
